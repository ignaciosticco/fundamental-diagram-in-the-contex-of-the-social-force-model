...
### DATA ###
data_2m = np.genfromtxt("flow-density_vd1_pasillo2m.txt",delimiter = ' ') 
density_2m = data_2m[:,0]
flow_2m = data_2m[:,1]

data_4m = np.genfromtxt("flow-density_vd1_pasillo4m.txt",delimiter = ' ') 
density_4m = data_4m[:,0]
flow_4m = data_4m[:,1]

data_10m = np.genfromtxt("flow-density_vd1_pasillo10m.txt",delimiter = ' ') 
density_10m = data_10m[:,0]
flow_10m = data_10m[:,1]

data_15m = np.genfromtxt("flow-density_vd1_pasillo15m.txt",delimiter = ' ') 
...
pylab.xlabel('Density~(Pm$^{-2}$) ',size='4.5',labelpad=1)
pylab.ylabel('Flow~(Pm$^{-1}$s$^{-1}$)  ',size='3.5',labelpad=-3,zorder=1)
#pylab.ylim(0.3, 1.1)
#pylab.xlim(0, 1.02)
