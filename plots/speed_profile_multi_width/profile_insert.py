...
ax1.plot(ancho_w4,v_media_w4,'bo',markersize=4,zorder=3,label='width=4m') 
ax1.plot(ancho_w4,v_media_w4,'b',lw=0.6,zorder=2)
ax1.errorbar(ancho_w4,v_media_w4,err_media_w4,linestyle='-',fmt='.',color='w',ecolor='b',zorder=1) 

ax1.plot(ancho_w15,v_media_w15,'go',markersize=4,zorder=3,label='width=15m') 
ax1.plot(ancho_w15,v_media_w15,'g',lw=0.6,zorder=2)
ax1.errorbar(ancho_w15,v_media_w15,err_media_w15,linestyle='-',fmt='.',color='w',ecolor='g',zorder=1) 

ax1.plot(ancho_w22,v_media_w22,'yo',markersize=4,zorder=3,label='width=22m') 
ax1.plot(ancho_w22,v_media_w22,'y',lw=0.6,zorder=2)
ax1.errorbar(ancho_w22,v_media_w22,err_media_w22,linestyle='-',fmt='.',color='w',ecolor='y',zorder=1) 

ax1.plot(ancho_w40,v_media_w40,'ro',markersize=4,zorder=3,label='width=40m') 
ax1.plot(ancho_w40,v_media_w40,'r',lw=0.6,zorder=2)
ax1.errorbar(ancho_w40,v_media_w40,err_media_w40,linestyle='-',fmt='.',color='w',ecolor='r',zorder=1) 


pylab.legend()
#pylab.xticks(np.arange(0,9,2))
#ax1.yticks(np.arange(0,1.1,0.25))
#ax1.xlabel('y-position~/~width ')
#ax1.ylabel('velocity (m/s)')
#ax1.ylim(0, 1.02)
#ax1.xlim(0, 1.02)
#lgd=plt.legend(numpoints=1,handlelength=0.8) 
ax1.legend(loc='best',labelspacing=0.1,borderpad=0.1,handletextpad=0.1,fontsize=6,numpoints=1)
