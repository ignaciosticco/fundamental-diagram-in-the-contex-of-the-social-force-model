...
So far we have that narrower corridors produce lower velocities along the corridor. We also learned that the velocity needs to be low enough to avoid the flow increment present in wider corridors. This inspired us to analyze the role of the friction coefficient in a simple model for the corridor (see Appendix \ref{appendix_2}).   
