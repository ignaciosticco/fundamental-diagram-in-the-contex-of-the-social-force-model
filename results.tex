...
In this subsection we have shown that the pedestrians in contact with the wall are the one with the higher work of friction force. 
...
In this subsection we have shown that an adequate modification of the friction coefficients yields a fundamental diagram with the congested branch reported in the literature. We discuss different approaches proposed by other authors in orther to attain this problem. See appendix for a more detailed discussion.
