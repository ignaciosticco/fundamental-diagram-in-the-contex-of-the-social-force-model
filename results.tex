...
For each density we studied the case in which $k_w$ and $k_i$ are both one order of magnitude higher than the original model (these correspond to the right hand side plots). For comparison reasons we also present the cluster size distribution for the original parameters of the Social force model (these correspond to the left hand side plots). 
