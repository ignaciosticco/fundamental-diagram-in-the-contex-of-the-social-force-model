...
{\color{red} Our simple schematic model (see Appendix \ref{appendix_2}) suggests 
...
{\color{red} All these phenomena suggest that further research needs to be  
...
on empirical values of $\kappa$ is still missing, to our knowledge. We aim to solve 
this issue. \\
