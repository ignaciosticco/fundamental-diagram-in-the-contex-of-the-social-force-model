...
social force model. We comapared empirical data recorded at 
...
to the other parameters in the model (see Appendix \ref{appendix_1}). A real concensus 
on empirical values of $\kappa$ is still missing, to our knowledge. We are 
...
no reason for changing other parameters, regarless of any specific situation. 
\\  
