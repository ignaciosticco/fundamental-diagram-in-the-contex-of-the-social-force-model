...
{\color{red} In the last years there have been proposed several extensions of 
the Social Force Model. These extensions solve numerical pitfalls \cite{koster1} 
and other issues such as oscillations, overlapping and non-realistic trajectories
\cite{chraibi1,dietrich1}. All of these improvements cape well with 
microscopic and low density drawbacks. It was also proposed that the
interaction forces between individuals are anisotropic and velocity-dependent
 \cite{johansson1}.  This variant of the Social Force Model makes
it possible to fit experimental data at the cost of incorporating extra parameters.}\\
